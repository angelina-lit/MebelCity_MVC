...
namespace MebelCity.DataAccess.Migrations
{
    ...
    [Migration("20240628160622_NewVMPriceListAndColumn")]
    partial class NewVMPriceListAndColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ColumnPriceList", b =>
                {
                    b.HasOne("MebelCity.Models.Column", null)
                        .WithMany()
                        .HasForeignKey("ColumnsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MebelCity.Models.PriceList", null)
                        .WithMany()
